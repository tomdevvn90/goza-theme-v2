    ...
    return (props) => {
        ...
        return (
            <Fragment>
                ...
                <InspectorControls>
                    <PanelBody
                        title={__('Responsive Typography', 'goza')}
                    >
                        <NavigableMenu className="goza-responsive-toggle" onNavigate={() => { }} orientation="horizontal">
                            <Button
                                icon="laptop"
                                showTooltip
                                label={__('Desktop view', 'goza')}
