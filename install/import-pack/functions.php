...

{
    ...
    function beplus_import_pack_defineds() {
        ...
        define( 'IMPORT_THEMENAME', apply_filters( 'beplus/import_pack/themename', 'goza' ) );
        define( 'IMPORT_URI', apply_filters( 'beplus/import_pack/import_uri', beplus_import_pack_path_to_url() ) );
        define( 'IMPORT_REMOTE_SERVER', apply_filters( 'beplus/import_pack/import_remote_server', 'https://package.beplusthemes.com/goza/' ) );
