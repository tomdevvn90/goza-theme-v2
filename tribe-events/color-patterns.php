 ...
 */
function goza_events_custom_colors_css() {

	$main_color = absint( goza_get_option( 'main_color' ) );

	/**
	 * Filter goza default saturation level.
	 *
	 * @since goza 7.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = apply_filters( 'goza_scheme_color_saturation', 100 );
	$saturation = absint( $saturation ) . '%';

	/**
	 * Filter goza default lightness level.
	 *
	 * @since goza 7.0
	 *
	 * @param int $lightness Color lightness level.
	 */
	$lightness = apply_filters( 'goza_scheme_color_lightness', 33 );
	$lightness = absint( $lightness ) . '%';

	/**
	 * Filter goza default hover lightness level.
	 *
	 * @since goza 7.0
	 *
	 * @param int $lightness_hover Hover color lightness level.
	 */
	$lightness_hover = apply_filters( 'goza_scheme_color_lightness_hover', 23 );
	...
	if( 'custom' == goza_get_option('custom_colors') ) {
		$base_color = goza_get_option( 'custom_color' );
	...
	/**
	 * Filters goza custom colors CSS.
	 *
	 * @since goza 7.0
	 *
	 ...
	 */
	return apply_filters( 'goza_events_custom_colors_css', $theme_css, $base_color, $hover_color );
}
